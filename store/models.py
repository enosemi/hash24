...
class Order(models.Model):
    user = models.ForeignKey(User, verbose_name="User", on_delete=models.CASCADE)
    address = models.ForeignKey(Address, verbose_name="contractprice", on_delete=models.CASCADE)
    product = models.ForeignKey(Product, verbose_name="discount", on_delete=models.CASCADE)
